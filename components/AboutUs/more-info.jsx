...
const AboutUsMore = () => {
  return (
    <section className="w-full px-4 pt-6 pb-10 md:pt-12 md:pb-12 bg-[#ffffffb3] ">
        ...
        <div className="more-info-area group flex flex-col md:flex-row items-center justify-between gap-4 md:gap-7">
          ...
          <div className="company-img w-ful md:w-2/5 order-1 md:order-2">
            <img
              ...
              className="h-full w-full p-6 scale-90 group-hover:scale-100 transition duration-700 drop-shadow-md group-hover:drop-shadow-lg"
              alt="logo"
            />
          </div>
        </div>
