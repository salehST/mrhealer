            ...
            <div className="contact-info grid grid-cols-1 md:grid-cols-3 gap-7">
                <div className="info-box p-8 bg-white rounded-2xl shadow hover:shadow-lg">
                    <div className="icon-area mb-6">
                        <svg width="78" height="78" viewBox="0 0 78 78" className=' h-24 w-auto' fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_156_1038)">
                            <path d="M54.9018 54.6001L51.8957 60.2528L66.6143 57.8465C63.6441 56.3567 59.6232 55.292 54.9018 54.6001ZM16.986 55.8325C10.1688 57.6304 5.84998 60.5765 5.84998 64.9523C5.85278 65.8943 6.0587 66.8247 6.4537 67.6799L30.076 63.8189L16.986 55.8325ZM71.5962 62.4001L38.7192 67.7587L47.3897 77.6226C61.6278 76.3473 72.15 71.7991 72.15 64.9523C72.15 64.0397 71.9534 63.191 71.5962 62.4001ZM33.164 68.683L10.9496 72.3139C16.8215 75.9518 27.1853 78.0001 39 78.0001C39.716 78.0001 40.4157 77.9798 41.1208 77.965L33.164 68.683Z" fill="#232323"/>
                            <path d="M39.0016 0C26.2876 0 15.8558 10.3997 15.8558 23.0849C15.8558 27.9614 17.4057 32.5042 20.0226 36.2396L35.0251 62.1746L35.0891 62.258C35.6811 63.031 36.2591 63.641 36.9377 64.0895C37.6163 64.5388 38.4587 64.8071 39.2855 64.7244C40.9375 64.559 41.9492 63.3922 42.9094 62.0911L42.9608 62.024L59.5234 33.8341L59.5327 33.8161C59.9212 33.1141 60.2082 32.3996 60.4516 31.7039C61.5688 28.9677 62.1436 26.0404 62.1442 23.0849C62.1442 10.3997 51.7156 0 39.0016 0ZM39.0016 13.2951C44.5169 13.2951 48.8218 17.5921 48.8218 23.0841C48.8218 28.5776 44.5169 32.8731 39.0016 32.8731C33.4854 32.8731 29.1782 28.5769 29.1782 23.0841C29.1782 17.5929 33.4862 13.2951 39.0016 13.2951Z" fill="#232323"/>
                            </g>
                            <defs>
                ...
                <a href="mailto:info@mrhealerbd.com" className="info-box p-8 bg-white rounded-2xl shadow hover:shadow-lg">
                    ...
                    <div className="info-texts">
                    <h6 className="text-black text-2xl font-bold mb-2 contact-title">E-mail:</h6> 
                     

                        <p className=' text-black text-base font-normal mb-2 underline'>info@mrhealerbd.com</p> 
                    </div>
                </a>
            </div>
        </div>
