  ...
  return (
    <section className="w-full bg-white p-4 md:py-20 faq">
      <div className="container mx-auto max-w-screen-xl overflow-hidden">
        ...
        >
          <h3 className="text-4xl md:text-5xl text-[#2F2F2F] font-bold  mx-auto w-auto">
            FAQ's
          </h3>
        </div>
        <div id="accordion" className="mx-auto w-full md:w-8/12">
          <div data-aos="fade-up-right" data-aos-delay="200" className="">
            ...
            >
              <div className="py-4 px-5 border border-[#efefef] shadow-md mb-3 rounded-md text-[#2F2F2F] leading-7">
                <span className="text-primary font-semibold">Telemedicine</span>{" "}
                is the practice of providing medical care and consultation
                remotely using technology, such as video conferencing, phone
                calls, and messaging.
              </div>
            </div>
          </div>
          <div data-aos="fade-up-left" data-aos-delay="200" className="">
            ...
            >
              <div className="py-4 px-5 border border-[#efefef] shadow-md mb-3 rounded-md text-[#2F2F2F] leading-7">
                <span className="text-primary font-semibold">Telemedicine</span>{" "}
                works by allowing patients to communicate with healthcare
                providers through secure online platforms, video conferencing,
                or phone calls. Patients can receive diagnosis, treatment, and
          ...
          <div className="">
            <h4 className="accordion-header mb-3" id="headingThree">
              ...
              >
                What types of medical conditions can be treated through
                telemedicine?
                <span className="ml-auto -mr-1 h-5 w-5 shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-200 ease-in-out group-[[data-te-collapse-collapsed]]:mr-0 group-[[data-te-collapse-collapsed]]:rotate-0 group-[[data-te-collapse-collapsed]]:fill-[#212529] motion-reduce:transition-none dark:fill-blue-300 dark:group-[[data-te-collapse-collapsed]]:fill-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div className="py-4 px-5 border border-[#efefef] shadow-md mb-3 rounded-md text-[#2F2F2F] leading-7">
                ...
                including minor illnesses, chronic conditions, and mental health
                issues. It is not suitable for emergencies or life-threatening
          ...
          <div className="">
            <h4 className="accordion-header mb-3" id="heading5">
              ...
              >
                What equipment do I need to participate in a telemedicine
                appointment?
                <span className="ml-auto -mr-1 h-5 w-5 shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-200 ease-in-out group-[[data-te-collapse-collapsed]]:mr-0 group-[[data-te-collapse-collapsed]]:rotate-0 group-[[data-te-collapse-collapsed]]:fill-[#212529] motion-reduce:transition-none dark:fill-blue-300 dark:group-[[data-te-collapse-collapsed]]:fill-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <div className="py-4 px-5 border border-[#efefef] shadow-md mb-3 rounded-md text-[#2F2F2F] leading-7">
                You will typically need a smartphone or smart device supporting
                Mr. Healer app and a secure internet connection to participate
                in an online appointment.
              </div>
            </div>
          </div>
          <div className="">
            ...
            >
              <div className="py-4 px-5 border border-[#efefef] shadow-md mb-3 rounded-md text-[#2F2F2F] leading-7">
                Telemedicine platforms are designed to be secure and private,
                with encryption and other measures to protect patient data.
                However, it is important to use a secure and private internet
                connection and to ensure that no one else can access the device
                being used for the appointment.
              </div>
            </div>
          </div>
        </div>
        <div className="flex justify-center items-center mt-8 mb-5">
          ...
          >
            ...
            <svg
              ...
              height="20"
              viewBox="0 0 20 20"
              className="relative left-2 transition h-5 w-5"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
