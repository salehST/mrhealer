          ...
          <div className="info-area rounded-lg bg-white shadow-md hover:shadow-lg transition px-6 py-10">
            ...
            <div className="texts-area">
              <ul className="list-disc list-outside pl-6 space-y-4 text-base text-black">
                ...
                <li>
                  Your report will be delivered within the shortest possible
                  time through email or home delivery.
                </li>
              </ul>
            </div>
          </div>
          <div className="info-area rounded-lg bg-white shadow-md hover:shadow-lg transition px-6 py-10">
            ...
            <div className="texts-area">
              <ul className="list-disc list-outside pl-6 space-y-4 text-base text-black">
                ...
                <li>
                  One of our “A Grade Pharmacists” will confirm your order via
                  call.
                </li>
                <li>
